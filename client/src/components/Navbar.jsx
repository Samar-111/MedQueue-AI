  ...
  return (
    <header className="sticky top-0 z-40 w-full px-4 lg:px-8 py-3">
      <div className="max-w-7xl mx-auto glass-dock rounded-full px-6 py-3 flex flex-col md:flex-row items-center justify-between gap-4 shadow-xl">
        ...
        <nav className="flex items-center gap-1.5 sm:gap-2 bg-slate-100/90 backdrop-blur-md p-1.5 rounded-full border border-slate-200 shadow-inner">
          {views.map((tab) => {
            const Icon = tab.icon;
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-full bg-white hover:bg-slate-50 border border-slate-200 text-xs font-extrabold text-slate-800 hover:text-orange-600 transition-all duration-200 hover:scale-105 shadow-sm"
          >
